...
public class GNSSProcessor {
    ...
    private static final int UBX_CLASS_GNSS = 0x06;//class cho UBX-CFG-GNSS
    private static final int UBX_ID_GNSS = 0x3E; //ID cho UBX-CFG-GNSS
        ...
        switch (currentState) {
            ...
            case COLLECTING_HEADER:
                ...
                if (messageIndex == 6) { // Header complete
                    if (messageBuffer[2] == UBX_CLASS_GNSS && messageBuffer[3] == UBX_ID_GNSS) {
                        ...
                        // Reset nếu không phải bản tin UBX-GNSS
                        resetProcessor();
                    }
                }
                break;
